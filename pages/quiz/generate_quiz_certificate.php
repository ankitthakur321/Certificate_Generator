                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-bordered">
                          ...
                          <?php
                            $mail_sent = null;
                            if(isset($_POST['QuizParticipantsList'])){
                                $qname = $_POST['quiz_name'];
                                $query = "SELECT * FROM feedback WHERE event_name='$qname' and mail_sent=0 ORDER BY f_id DESC LIMIT 10";
                          ...
                          <?php 
                              ...
                              {
                                echo "All the certificates has been generated for this quiz";
                    ...
                    <div class="d-flex justify-content-center">
                        <form method="post" class="mb-2" action="../../code.php">
                            <input type="hidden" name="quiz_name" value="<?php echo $wname; ?>"/>
                                <button type="submit" id = "generateBtn" class="btn btn-success btn-icon-text" name="GenerateQuizCertificateBtn" value="GenerateCertificate">
