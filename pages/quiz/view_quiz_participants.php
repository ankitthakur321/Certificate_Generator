...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="text-center">
          ...
          <h6><small class="text-muted"> All the details of the participants of the quiz are mentioned here. </small></h6>
        </div>
        <br/><br/>
        <?php
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <div class="input-group">
                        ...
                        <div class="input-group-append">
                          <input class="btn btn-primary" type="submit" name="importQuizPrtcptBtn" value="Import">
                        </div>
                      </div>
                    </div>
        </form>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <?php
                      $query = "SELECT * FROM quiz ORDER BY p_id DESC LIMIT $result, $row_per_page";
                  ...
                  ?>
                          <tbody>
                            <tr class="text-center">
                              ...
                              <td><?php if($row['mail_sent'] == 0){ echo 'No';}else{ echo 'Yes';} ?></td>
                            </tr>
                          </tbody>
                  <?php 
                        }
