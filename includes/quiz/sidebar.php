        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="participants">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../participants/view_participants.php">View Participants</a></li>
                <li class="nav-item"> <a class="nav-link" href="../participants/view_webinar_list.php">Generate Certificate</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="quiz">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="view_quiz_participants.php">View Participants</a></li>
                <li class="nav-item"> <a class="nav-link" href="view_quiz_list.php">Generate Certificate</a></li>
              </ul>
            </div>
          </li>
        </ul>
