          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="webinar">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/events/view_events.php">View Events</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/events/view_quiz_events.php">View Quiz Events</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="participants">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/participants/view_participants.php">View Participants</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/participants/view_webinar_list.php">Generate Certificate</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="quiz">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/quiz/view_quiz_participants.php">View Participants</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/quiz/view_quiz_list.php">Generate Certificate</a></li>
              </ul>
            </div>
          </li>
