          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="webinar">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="view_events.php">View Events</a></li>
                <li class="nav-item"> <a class="nav-link" href="view_quiz_events.php">View Quiz Events</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
